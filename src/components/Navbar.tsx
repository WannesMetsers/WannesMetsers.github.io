...
<div className="relative w-1/2">
  <div className="bg-blue-950 h-20 flex justify-left items-center px-4 sm:px-6 lg:px-8  overflow-hidden">
    ...
    <div className="hidden md:flex space-x-4">
      {["Home", "Mijn vaardigheden", "Contact"].map((item, index) => (
        <a
          key={index}
    ...
    <div className="md:hidden ml-2">
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-100">
          ...
          <a href="#" className="block px-4 py-2 hover:bg-gray-200">Portfolio</a>
          {/* <a href="#" className="block px-4 py-2 hover:bg-gray-200">Videos</a> */}
